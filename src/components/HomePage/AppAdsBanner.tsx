...
const AppAdsBanner = () => {
  return (
    <div
      className="flex flex-col w-full justify-center items-center bg-[#001132]"
      id="download"
    >
      <div
        className={
      ...
      >
        <div className="flex flex-row relative justify-center items-center w-full max-w-[564px]">
          <img className="max-sm:w-full" width={564} src={AppReg} alt="App" />
        </div>
